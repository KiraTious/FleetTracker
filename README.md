...
- Открытые порты 5000 (API) и 5432 (PostgreSQL) или измените их в `docker-compose.yml`.
...
- `DATABASE_URL` — строка подключения к БД (пример: `postgresql://postgres:postgres@db:5432/fleettracker`).
